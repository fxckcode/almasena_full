...
function SignIn() {
    ...
    return (
        <>
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full max-h-full">
                <div className="flex items-center">
                    <div className="hidden xl:flex xl:w-1/2">
                        <img src={loginImage} alt="" className='max-h-screen object-cover w-full brightness-50'/>
                    </div>
                    <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                Inicia Sesión en <span className='text-primary'>AlmaSENA</span>
                            </h2>
